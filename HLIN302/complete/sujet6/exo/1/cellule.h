...
class Cellule {
 ...
 public:
  ...
  // __TD6__
  bool estDifferente(const Cellule&)const;
  bool estEquivalente(const Cellule&)const;
  bool estAvantOuEquivalente(const Cellule&)const;
  bool estApresOuEquivalente(const Cellule&)const;
  bool estAvant(const Cellule&)const;
  bool estApres(const Cellule&)const;
};
